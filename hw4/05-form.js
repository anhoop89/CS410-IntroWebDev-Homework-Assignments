...
function handleSubmit(event) {
  ...
  if (
    !isNaN(form.username.value) &&
    !isNaN(form.email.value) &&
    !isNaN(form.date.value) &&
    !form.answer.checked
  )
    ...
    else console.log("\tUsername   : " + form.username.value);
    ...
    //Newsletter
    if (!isNaN(form.answer.value)) console.log("\tNewsletter : no submission");
    else {
    ...
    //Date
    if (!isNaN(form.date.value)) console.log("\tDate       : no submission");
